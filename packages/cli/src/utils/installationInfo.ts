...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @aptx-cli/aptx-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @aptx-cli/aptx-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @aptx-cli/aptx-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @aptx-cli/aptx-cli@latest';
    return {
