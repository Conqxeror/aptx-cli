...
const OAUTH_CLIENT_ID =
  process.env.GOOGLE_OAUTH_CLIENT_ID || 'your-google-oauth-client-id.apps.googleusercontent.com';

// OAuth Secret value used to initiate OAuth2Client class.
// Note: For installed applications, client secrets are not treated as secrets
// but we use environment variables to avoid GitHub secret scanning alerts
