...
import { ReconTool } from '../tools/recon.js';
import { VulnScanTool } from '../tools/vuln-scan.js';
import { AdvancedVulnHuntTool } from '../tools/advanced-vuln-hunt.js';
import { AdvancedReconTool } from '../tools/advanced-recon.js';
import { PayloadGeneratorTool } from '../tools/payload-generator.js';
import { ExploitFrameworkTool } from '../tools/exploit-framework.js';
import { MonkModeTool } from '../tools/monk-mode.js';
...
export class Config {
  ...
  async createToolRegistry(): Promise<ToolRegistry> {
    ...
    registerCoreTool(ReconTool, this);
    registerCoreTool(VulnScanTool, this);
    registerCoreTool(AdvancedVulnHuntTool, this);
    registerCoreTool(AdvancedReconTool, this);
    registerCoreTool(PayloadGeneratorTool, this);
    registerCoreTool(ExploitFrameworkTool, this);
    registerCoreTool(MonkModeTool, this);
